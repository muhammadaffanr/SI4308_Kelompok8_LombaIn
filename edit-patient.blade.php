...
@section('content')
<div class="row mt-5 ">
    <h3 class="text-center mb-3">Edit $vaccine->name Patient</h3>
    <form method="post" action="/update-patient/{{$patient->id}}">
    @csrf
    @method('patch')
        <div class="mb-3">
        ...
        <div class="mb-3">
            <div class="row">
                ...
                <input type="file" name="image_ktp" class="form-control-file" value="{{$patient->ktp}}">
            </div>
        </div>
        <div class="mb-3">
            <label for="no_hp" class="form-label">No Hp</label>
            <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{$patient->no_hp}}" required>
        </div>
